        ...
        execute: function () {
            exports_1("Ohlc", Ohlc = {
                create: (depth, options) => {
                    var nglyphs = options['data'].length / 4, first_dynamic_index = options['first_dynamic_index'], last_static_index = first_dynamic_index + 1, data = options['data'], past = [], recent = [], 
                    ...
                    return { past: past, recent: recent };
                } 
            });
        }
    };
